        ...
        if(b==0)
 		...
 		public static void main(String... as) throws Exception
 		{
 			...
 			while(a-->0)
 			{
 					...
 					{
 						if(s.charAt(i)=='A'||s.charAt(i)=='E'||s.charAt(i)=='I'||s.charAt(i)=='O'||s.charAt(i)=='U'||s.charAt(i)=='a'||s.charAt(i)=='e'||s.charAt(i)=='i'||s.charAt(i)=='o'||s.charAt(i)=='u'||s.charAt(i)=='y'||s.charAt(i)=='Y')continue;
 						else out("."+Character.toLowerCase(s.charAt(i)));
 					}
